...
nethack|https://github.com/NetHack/NetHack.git|NetHack-5.0|pipeline:scripts/adapters/build_appimage_nethack.sh
nethack37|https://github.com/NetHack/NetHack.git|NetHack-3.7|pipeline:scripts/adapters/build_appimage_nethack37.sh
nethack36|https://github.com/NetHack/NetHack.git|NetHack-3.6|pipeline:scripts/adapters/build_appimage_nethack36.sh
